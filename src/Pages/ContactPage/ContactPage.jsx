...
export default function ContactPage(){
    return(
        ...
        <h2 className='contactP'>
            ...
            <p className='contactP'>
                My Resume: <a href='https://docs.google.com/document/d/1uA1LyqqLQ8z1znlez03gOlMiDvu-i97l/edit?usp=drive_link&ouid=111455401108678639432&rtpof=true&sd=true' target="_blank"><button>Resume</button></a>
            </p>
        </>
    )
}